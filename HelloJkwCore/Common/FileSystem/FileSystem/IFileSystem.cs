...
public interface IFileSystem
{
    ...
    Task<T> ReadJsonAsync<T>(Func<Paths, string> pathFunc, JsonConverter[] converters = null, CancellationToken ct = default);
    Task<bool> WriteJsonAsync<T>(Func<Paths, string> pathFunc, T obj, CancellationToken ct = default);
    Task<bool> WriteJsonAsync<T>(Func<Paths, string> pathFunc, T obj, JsonConverter[] converters, CancellationToken ct = default);
